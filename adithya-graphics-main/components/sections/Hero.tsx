      ...
      if (index < headlines.length - 1) {
        ...
        timeline.add(() => {
          if (headlineRef.current) {
            const nextHeadline = headlines[index + 1]
            if (nextHeadline) {
              headlineRef.current.textContent = nextHeadline
            }
          }
        }, index * 2.5 + 0.8)
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://drive.google.com/file/d/1iGn_9x_IkAc5W77JgWDL5u_IbjRjYqF6/view?usp=drive_link"
          alt="Hero background"
          fill
          priority
